...
public class LoginActivity extends AppCompatActivity implements LoaderCallbacks<Cursor> {
   ...
   // private UserLoginTask mAuthTask = null;
                        ...
                        .addOnCompleteListener(this, new OnCompleteListener<AuthResult>() {
                            ...
                            public void onComplete(@NonNull Task<AuthResult> task) {
                                ...
                                if (task.isSuccessful()) {
                                    ...
                                    UserNmaeDialogInterface userNmaeDialogInterface = new UserNmaeDialogInterface();
                                    userNmaeDialogInterface.show(getFragmentManager(),null);
    ...
    public static class UserNmaeDialogInterface extends DialogFragment{
        @Override
        public Dialog onCreateDialog(Bundle savedInstanceState) {
            ...
            builder.setView(inflater.inflate(R.layout.chat_dialogue, null))
                    // Add action buttons
